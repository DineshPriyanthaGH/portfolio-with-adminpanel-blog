        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <a
                href="/src/assets/Dinesh_Priyantha_CV.pdf"
                download
                className="professional-card border-border text-foreground hover:bg-accent px-8 py-3 inline-flex items-center justify-center rounded-md border bg-transparent font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
              >
